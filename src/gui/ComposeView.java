...
public class ComposeView {
    ...
    private void showAlert(String title, String content) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION); // Using Confirmation to avoid complex dialog setup if
                                                               // Alert not perfectly styled
        // But Standard Alert might handle styling if CSS attached to DialogPane
        // Simple console fallback not needed if using JavaFX standard.
        // Let's rely on standard Alert but try to style it strictly speaking.
        // For quickness, just standard alert.
